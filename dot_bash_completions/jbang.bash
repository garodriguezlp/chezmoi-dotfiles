...
function _picocli_jbang_run() {
  ...
  case ${prev_word} in
    ...
    --files)
      ...
      ;;
    --source-type)
      COMPREPLY=( $( compgen -W "${forceType_option_args}" -- "${curr_word}" ) )
      return $?
      ;;
    --catalog)
      local IFS=$'\n'
...
function _picocli_jbang_alias_add() {
  ...
  local commands=""
  local flag_opts="-h --help --insecure --global -g --jsh -n --native --enableassertions --ea --enablesystemassertions --esa --cds -i --interactive --enable-preview --verbose --quiet -o --offline --fresh"
...
function _picocli_jbang_trust_list() {
  ...
  case ${prev_word} in
    --format)
      COMPREPLY=( $( compgen -W "${arg0_option_args}" -- "${curr_word}" ) )
      return $?
      ;;
  esac
...
function _picocli_jbang_jdk_list() {
  ...
  case ${prev_word} in
    --format)
      COMPREPLY=( $( compgen -W "${arg2_option_args}" -- "${curr_word}" ) )
      return $?
      ;;
  esac
...
function _picocli_jbang_app_install() {
  ...
  local commands=""
  local flag_opts="-h --help --insecure --native --force --verbose --quiet -o --offline --fresh"
